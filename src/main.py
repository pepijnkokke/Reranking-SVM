...
def run():
    ...
    matrix = [
        ('sgd-test',                        0, test_size, test_size, False, False, False, False),
        ('sgd-100-baseline',                0, 100, 200, False, False, False, False),
        ('sgd-100-baseline-500',            0, 100, 500, False, False, False, False),
        ('sgd-100-baseline-1000',           0, 100, 1000, False, False, False, False),
        ('sgd-100-pos',                     0, 100, 200, True, False, False, False),
        ('sgd-100-ex-pos',                  0, 100, 200, True, True, False, False),
        ('sgd-100-pos-bigrams',             0, 100, 200, True, False, True, False),
        ('sgd-100-ex-pos-bigrams',          0, 100, 200, True, True, True, False),
        ('sgd-100-representation',          0, 100, 200, False, False, False, True),
        ('sgd-100-full',                    0, 100, 200, True, True, True, True),
        ('sgd-500-baseline',                0, 500, 100, False, False, False, False),
        ('sgd-500-pos',                     0, 500, 100, True, False, False, False),
        ('sgd-500-ex-pos',                  0, 500, 100, True, True, False, False),
        ('sgd-500-pos-bigrams',             0, 500, 100, True, False, True, False),
        ('sgd-500-ex-pos-bigrams',          0, 500, 100, True, True, True, False),
        ('sgd-500-representation',          0, 500, 100, False, False, False, True),
        ('sgd-500-full',                    0, 500, 100, True, True, True, True),
        ('sgd-2900-full',                   0, 2900, 100, True, True, True, True),
        ('sgd-2900-baseline',               0, 2900, 100, False, False, False, False),
        ('sgd-2900-baseline-200',           0, 2900, 200, False, False, False, False),
        ('sgd-2900-baseline-300',           0, 2900, 300, False, False, False, False),
        ('sgd-2900-pos',                    0, 2900, 100, True, False, False, False),
        ('sgd-2900-ex-pos',                 0, 2900, 100, True, True, False, False),
        ('sgd-2900-pos-bigrams',            0, 2900, 100, True, False, True, False),
        ('sgd-2900-ex-pos-bigrams',         0, 2900, 100, True, True, True, False),
        ('sgd-2900-representation',         0, 2900, 100, False, False, False, True),
        ('sgd-2900-full-200',               0, 2900, 200, True, True, True, True),
    ]
